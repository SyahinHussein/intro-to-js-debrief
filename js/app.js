...
//      * If the variable input is not an item in the store, then print 'Invalid Item' to the console.
    ...
    let priceOfEachItem = 'Socks';
    switch(priceOfEachItem){
        case 'Shoes':
        return console.log('Shoes are $50');
        break;
        case 'Jeans':
        return console.log('Jeans are $25');
        break;
        case 'Hat':
        return console.log('Hats are $12');
        break;
        case 'Socks':
        return console.log('Socks are $2');
        break;
        default:
